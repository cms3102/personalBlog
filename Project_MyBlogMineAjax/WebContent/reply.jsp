...
<%
int parent_id = Integer.parseInt(request.getParameter("article_id"));
%>
		...
		<!-- Main -->
			<section id="main" class="wrapper style1">
				...
				<div class="container">
                    ...
                    <td><%= userId %> <input type="hidden" name="writer" value="<%= userId %>"></td>
                    <td class="post1">비밀번호</td>
